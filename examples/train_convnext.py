"""Train ConvNeXt-Tiny on CIFAR-10 for 5 epochs.

ConvNeXt is a pure convolutional neural network designed to match or exceed
Vision Transformers by modernising a standard ResNet with design choices
inspired by the transformer era: larger kernels (7x7), inverted bottlenecks,
fewer normalisation layers, and GELU activations.
Reference: Liu et al., 2022 (https://arxiv.org/abs/2201.03545)
"""
...
IMAGE_SIZE = 224      # ConvNeXt standard resolution
BATCH_SIZE = 64
EPOCHS     = 5
LR         = 1e-3
OUTPUT_DIR = "runs/convnext_tiny"
